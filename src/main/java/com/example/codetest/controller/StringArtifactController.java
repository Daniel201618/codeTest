...
public class StringArtifactController {
   ...
   public OutputResultDTO resolveStr(@RequestBody StringArtifact strArtifact){
        /* 根据策略模式，处理不同需求类型的字符串*/
        ...
        OutputResultDTO outputResult =  stringArtifact.resolveStr(order,strArtifact.getInput());
        return outputResult;
   }
